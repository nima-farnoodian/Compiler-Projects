...
public class ASTTests {
	...
	public void test_literal() {
		...
		Assert.assertTrue(result.fullMatch);
		Assert.assertEquals(12345, (long) value.value);
	}
	...
	public void test_indexCollectionAccess() {
		...
		Assert.assertEquals(25, (long) index.value);
	}
	...
	public void test_functionCall() {
		...
		Assert.assertEquals(10, (long) arg2.value);
	}
	...
	public void test_multiplication() {
		...
		Assert.assertEquals(15, (long) right.value);
	}
	...
	public void test_addition() {
		...
		Assert.assertTrue(result.fullMatch);
		Assert.assertEquals(25, (long) left.value);
	...
	public void test_unaryMinus() {
		...
		Assert.assertEquals("numbers", identifier.value);
		Assert.assertEquals(100, (long) index.value);
	}
	...
	public void test_simpleAssignment() {
		...
		Assert.assertEquals(0, (long) index.value);
		Assert.assertEquals(op.name(), BinaryOperator.ASSIGNMENT.name());
		Assert.assertEquals(5, (long) right.value);
	}
	...
	public void test_variableDefinition() {
		...
		Assert.assertEquals("x", identifier.value);
		Assert.assertEquals(op.name(), BinaryOperator.ASSIGNMENT.name());
		Assert.assertEquals(123, (long) value.value);
	}
}
