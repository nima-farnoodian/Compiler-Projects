...
public class SemanticDeclarationsTests {
	...
	@Test
	public void test_variableDefinition_redefinition_failure() {
		String input = """
			proc main([string]: _args_) {
				var int: x = 25
				val bool: x = TRUE
	...
	@Test
	public void test_funcDefinition() {
		String input = """
			func int sum(int: x, int: y) {return x + y}
