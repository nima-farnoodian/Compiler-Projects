...
public final class ExpressionsTests {
	...
	@Test
	public void test_arrayAccess_success1() {
		String input = "x[0]";
	...
	@Test
	public void test_arrayAccess_success2() {
	...
	@Test
	public void test_arrayAccess_success3() {
	...
	@Test
	public void test_arrayAccess_badBrackets_failure() {
		String input = "x{1}";
		ParseResult result = Autumn.parse(parser.indexedCollectionAccess, input, ParseOptions.get());
	...
	@Test
	public void test_mapAccess_success1() {
		String input = "x[5]";
		ParseResult result = Autumn.parse(parser.indexedCollectionAccess, input, ParseOptions.get());
		Assert.assertTrue(result.fullMatch);
	}
	...
	@Test
	public void test_mapAccess_success2() {
	...
	@Test
	public void test_mapAccess_success3() {
		String input = "x[str]";
		ParseResult result = Autumn.parse(parser.indexedCollectionAccess, input, ParseOptions.get());
		Assert.assertTrue(result.fullMatch);
	}
	...
	@Test
	public void test_multiplication_nonNumericArgs_failure() {
		String input = "\"abcdef\"";
		ParseResult result = Autumn.parse(parser.multiplicationExpression, input, ParseOptions.get());
		Assert.assertFalse(result.fullMatch);
	}
	...
	@Test
	public void test_addition_nonNumericArgs_failure() {
		String input = "\"abcdef\"";
		ParseResult result = Autumn.parse(parser.additionExpression, input, ParseOptions.get());
		Assert.assertFalse(result.fullMatch);
	}
	...
	@Test
	public void test_arrayAssignment_empty_success() {
		String input = "x = []";
		ParseResult result = Autumn.parse(parser.arrayAssignment, input, ParseOptions.get());
		Assert.assertTrue(result.fullMatch);
	}
	
	@Test
	public void test_arrayAssignment_ints_success() {
	...
	@Test
	public void test_arrayAssignment_strings_success() {
	...
	@Test
	public void test_arrayAssignment_singleElement_success() {
		String input = "x = [1]";
		ParseResult result = Autumn.parse(parser.arrayAssignment, input, ParseOptions.get());
		Assert.assertTrue(result.fullMatch);
	}
	...
	@Test
	public void test_arrayAssignment_whitespace_success() {
		String input = "x = [ 1,2 , 3]";
		ParseResult result = Autumn.parse(parser.arrayAssignment, input, ParseOptions.get());
		Assert.assertTrue(result.fullMatch);
	}
	...
	@Test
	public void test_arrayAssignment_wrongBrackets_failure() {
		String input = "x = { 1,2 , 3}";
		ParseResult result = Autumn.parse(parser.arrayAssignment, input, ParseOptions.get());
		Assert.assertFalse(result.fullMatch);
	}
	...
	@Test
	public void test_arrayAssignment_trailingComma_failure() {
		String input = "x = [1,]";
		ParseResult result = Autumn.parse(parser.arrayAssignment, input, ParseOptions.get());
		Assert.assertFalse(result.fullMatch);
	}
	...
	@Test
	public void test_mapAssignment_empty_success1() {
		String input = "x = {}";
		ParseResult result = Autumn.parse(parser.mapAssignment, input, ParseOptions.get());
		Assert.assertTrue(result.fullMatch);
	}
	
	@Test
	public void test_mapAssignment_empty_success2() {
		String input = "x = map()";
		ParseResult result = Autumn.parse(parser.mapAssignment, input, ParseOptions.get());
		Assert.assertTrue(result.fullMatch);
	}
	...
	@Test
	public void test_mapAssignment_success1() {
	...
	@Test
	public void test_mapAssignment_success2() {
	...
	@Test
	public void test_mapAssignment_failure() {
	...
	@Test
	public void test_mapAssignment_trailingComma_failure() {
		String input = "x = {1:1,}";
		ParseResult result = Autumn.parse(parser.mapAssignment, input, ParseOptions.get());
		Assert.assertFalse(result.fullMatch);
	}
	...
	@Test
	public void test_assignment_array_success1() {
		String input = "x = [1, 2, 3]";
		ParseResult result = Autumn.parse(parser.assignment, input, ParseOptions.get());
		Assert.assertTrue(result.fullMatch);
	}
	...
	@Test
	public void test_assignment_array_success2() {
		String input = "x = []";
		ParseResult result = Autumn.parse(parser.assignment, input, ParseOptions.get());
		Assert.assertTrue(result.fullMatch);
	}
	...
	@Test
	public void test_assignment_array_success3() {
		String input = "x = array(100)";
		ParseResult result = Autumn.parse(parser.assignment, input, ParseOptions.get());
		Assert.assertTrue(result.fullMatch);
	}
	...
	@Test
	public void test_assignment_map_success1() {
		String input = "x = {1:1, 2:2, 3:3}";
		ParseResult result = Autumn.parse(parser.assignment, input, ParseOptions.get());
		Assert.assertTrue(result.fullMatch);
	}
	...
	@Test
	public void test_assignment_map_success2() {
		String input = "x = map()";
		ParseResult result = Autumn.parse(parser.assignment, input, ParseOptions.get());
		Assert.assertTrue(result.fullMatch);
	}
