...
public final class Instances {
	...
	public static final ListTypeNode BOOL_LIST = new ListTypeNode(new PrimitiveType(BasicType.BOOL));
	public static final ListTypeNode INT_LIST = new ListTypeNode(new PrimitiveType(BasicType.INT));
